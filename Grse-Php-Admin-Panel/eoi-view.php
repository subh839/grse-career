...
<body>
 ...
 <tbody>
    ...
    <h2 style=" text-align:center; margin:0;">EOI Details</h2><br>
  ...
  <tr>
    <td height="25" colspan="6" bgcolor="#FFFFFF"><span class="green_txt2"><strong><u style="color: #209006">Open EOI details :</u></strong></span> </td>
  </tr>
  <tr class="blackbold">
  ...
  <tr>
    <td height="22" bgcolor="#FFFFFF" class="tableHeadings"> &nbsp;EOI No.</td>
    <td width="278" height="22" bgcolor="#FFFFFF" class="content">&nbsp; <?php echo $post['eoiNum'] ?></td>

    <td height="22" bgcolor="#FFFFFF" class="blackbold tableHeadings">&nbsp;Date Of Publication</td>
    <td height="22" colspan="2" bgcolor="#FFFFFF" class="content">&nbsp; <?php echo $post['dateOfEoiPub'] ?></td>
</tr>
  ...
  <tr>
    ...
    <td height="22" colspan="5" align="left" valign="top" bgcolor="#FFFFFF"><?php echo $post['eoiDetails'] ?></td>
  </tr>
   <tr>
  </tr>
  ...
  <tr style="background-color: #FFF" class="Content">
    ...
    <td valign="top">&nbsp;</td>
        ...
        <!--     <td align="middle" valign="top">&nbsp;</td> -->
          ...
          <tr class="body">
            <td colspan="2" bgcolor="#FFFFFF"><span class="blackbold ">&nbsp;</span><span class="tableHeadings" style="color: #209006">Download EOI Document</span></td>
